...
CREATE TABLE `bid_rounds` (
  `id` int(11) NOT NULL,
  `coin_id` varchar(50) NOT NULL,
  `slot_number` bigint(20) NOT NULL DEFAULT 0,
  `duration` int(11) NOT NULL DEFAULT 33,
...
INSERT INTO `bid_rounds` (`id`, `coin_id`, `slot_number`, `duration`, `start_time`, `end_time`, `status`, `total_up_amount`, `total_down_amount`, `total_up_users`, `total_down_users`, `winning_side`, `created_at`) VALUES
(11, 'bitcoin', -886779881, -2, '2026-04-07 05:35:50', '2026-03-15 07:29:20', 'resolved', 970.00000000, 0.00000000, 1, 0, 'up', '2026-03-15 07:28:47'),
(12, 'bitcoin', -1773559809, -1, '2026-04-07 05:35:50', '2026-03-15 07:30:08', 'resolved', 0.00000000, 970.00000000, 0, 1, 'down', '2026-03-15 07:29:35'),
(13, 'bitcoin', -886779929, -2, '2026-04-07 05:35:50', '2026-03-15 07:30:56', 'resolved', 0.00000000, 97.00000000, 0, 1, 'down', '2026-03-15 07:30:23'),
(14, 'bitcoin', -886779949, -2, '2026-04-07 05:35:50', '2026-03-15 07:31:36', 'resolved', 0.00000000, 97.00000000, 0, 1, 'down', '2026-03-15 07:31:03'),
(15, 'bitcoin', -886779970, -2, '2026-04-07 05:35:50', '2026-03-15 07:32:17', 'resolved', 0.00000000, 97.00000000, 0, 1, 'down', '2026-03-15 07:31:44'),
(16, 'bitcoin', -1773559984, -1, '2026-04-07 05:35:50', '2026-03-15 07:33:03', 'resolved', 0.00000000, 970.00000000, 0, 1, 'down', '2026-03-15 07:32:30'),
(17, 'bitcoin', 53744244, 33, '2026-04-07 05:35:50', '2026-03-15 07:34:36', 'resolved', 0.00000000, 485.00000000, 0, 1, 'down', '2026-03-15 07:34:03'),
(18, 'bitcoin', -886789991, -2, '2026-04-07 05:35:50', '2026-03-15 13:06:19', 'resolved', 9.70000000, 0.00000000, 1, 0, 'up', '2026-03-15 13:05:46'),
(19, 'bitcoin', -886790036, -2, '2026-04-07 05:35:50', '2026-03-15 13:07:50', 'resolved', 9.70000000, 0.00000000, 1, 0, 'up', '2026-03-15 13:07:17'),
(20, 'bitcoin', -886790056, -2, '2026-04-07 05:35:50', '2026-03-15 13:08:30', 'resolved', 9.70000000, 0.00000000, 1, 0, 'up', '2026-03-15 13:07:57'),
(21, 'bitcoin', -1773580172, -1, '2026-04-07 05:35:50', '2026-03-15 13:09:31', 'resolved', 0.00000000, 9.70000000, 0, 1, 'down', '2026-03-15 13:08:58'),
(22, 'bitcoin', -886790115, -2, '2026-04-07 05:35:50', '2026-03-15 13:10:28', 'resolved', 0.00000000, 9.70000000, 0, 1, 'down', '2026-03-15 13:09:55'),
(23, 'bitcoin', -886790636, -2, '2026-04-07 05:35:50', '2026-03-15 13:27:50', 'resolved', 97.00000000, 0.00000000, 1, 0, 'up', '2026-03-15 13:27:17'),
(24, 'bitcoin', -1773672337, -1, '2026-04-07 05:35:50', '2026-03-16 14:45:36', 'resolved', 0.00000000, 0.00000000, 0, 0, 'down', '2026-03-16 14:45:03'),
(25, 'bitcoin', 53747646, 33, '2026-04-07 05:35:50', '2026-03-16 14:46:11', 'open', 0.00000000, 0.00000000, 0, 0, NULL, '2026-03-16 14:45:38');
...
--
-- Table structure for table `fd_upi_accounts`
--

CREATE TABLE `fd_upi_accounts` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `fd_usdt_wallets`
--

CREATE TABLE `fd_usdt_wallets` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fd_usdt_wallets`
--

INSERT INTO `fd_usdt_wallets` (`id`, `wallet_address`, `qr_image`, `display_name`, `is_active`, `created_at`) VALUES
(1, '0xEE6edC5cb5C07D7A1Eb2ec5EB953d640fE046152', '/img/qr1.jpeg', 'FD Wallet 1', 1, '2026-03-26 16:22:36'),
(2, '0x3cC8B270a33997a95AdB4511A701dD159734D433', '/img/qr2.jpeg', 'FD Wallet 2', 1, '2026-03-26 16:22:36'),
(3, '0xEb22c11a8f4A9028f7103CC303b43C4B0e35D476', '/img/qr3.jpeg', 'FD Wallet 3', 1, '2026-03-26 16:22:36'),
(4, '0x1a7d0e91aaCe0256Baf375C18c333165a49851a8', '/img/qr4.jpeg', 'FD Wallet 4', 1, '2026-03-26 16:22:36'),
(5, '0xED7D925FAab46C08fbbaba6AFbC382C6533c403a', '/img/qr5.jpeg', 'FD Wallet 5', 1, '2026-03-26 16:22:36');
...
(37, 2, 'deposit', 1000.00000000, NULL, 'completed', NULL, 'Bid UP on bitcoin (Fee: $30.0000)', '2026-03-15 07:28:47', 'BEP20', NULL, NULL),
(38, 2, 'deposit', 30.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:28:47', 'BEP20', NULL, NULL),
(39, 2, 'deposit', 1970.00000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #11)', '2026-03-15 07:29:22', 'BEP20', NULL, NULL),
(40, 2, 'deposit', 1000.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $30.0000)', '2026-03-15 07:29:35', 'BEP20', NULL, NULL),
(41, 2, 'deposit', 30.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:29:35', 'BEP20', NULL, NULL),
(42, 2, 'deposit', 100.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $3.0000)', '2026-03-15 07:30:23', 'BEP20', NULL, NULL),
(43, 2, 'deposit', 3.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:30:23', 'BEP20', NULL, NULL),
(44, 2, 'deposit', 197.00000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #13)', '2026-03-15 07:30:58', 'BEP20', NULL, NULL),
(45, 2, 'deposit', 100.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $3.0000)', '2026-03-15 07:31:03', 'BEP20', NULL, NULL),
(46, 2, 'deposit', 3.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:31:03', 'BEP20', NULL, NULL),
(47, 2, 'deposit', 197.00000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #14)', '2026-03-15 07:31:38', 'BEP20', NULL, NULL),
(48, 2, 'deposit', 100.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $3.0000)', '2026-03-15 07:31:44', 'BEP20', NULL, NULL),
(49, 2, 'deposit', 3.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:31:44', 'BEP20', NULL, NULL),
(50, 2, 'deposit', 1000.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $30.0000)', '2026-03-15 07:32:30', 'BEP20', NULL, NULL),
(51, 2, 'deposit', 30.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:32:30', 'BEP20', NULL, NULL),
(52, 2, 'deposit', 500.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $15.0000)', '2026-03-15 07:34:03', 'BEP20', NULL, NULL),
(53, 2, 'deposit', 15.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 07:34:03', 'BEP20', NULL, NULL),
(54, 2, 'deposit', 985.00000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #17)', '2026-03-15 07:34:36', 'BEP20', NULL, NULL),
...
(56, 2, 'deposit', 10.00000000, NULL, 'completed', NULL, 'Bid UP on bitcoin (Fee: $0.3000)', '2026-03-15 13:05:46', 'BEP20', NULL, NULL),
(57, 2, 'deposit', 0.30000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 13:05:46', 'BEP20', NULL, NULL),
(58, 2, 'deposit', 10.00000000, NULL, 'completed', NULL, 'Bid UP on bitcoin (Fee: $0.3000)', '2026-03-15 13:07:17', 'BEP20', NULL, NULL),
(59, 2, 'deposit', 0.30000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 13:07:17', 'BEP20', NULL, NULL),
(60, 2, 'deposit', 19.70000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #19)', '2026-03-15 13:07:52', 'BEP20', NULL, NULL),
(61, 2, 'deposit', 10.00000000, NULL, 'completed', NULL, 'Bid UP on bitcoin (Fee: $0.3000)', '2026-03-15 13:07:57', 'BEP20', NULL, NULL),
(62, 2, 'deposit', 0.30000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 13:07:57', 'BEP20', NULL, NULL),
(63, 2, 'deposit', 10.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $0.3000)', '2026-03-15 13:08:58', 'BEP20', NULL, NULL),
(64, 2, 'deposit', 0.30000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 13:08:58', 'BEP20', NULL, NULL),
(65, 2, 'deposit', 19.70000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #21)', '2026-03-15 13:09:32', 'BEP20', NULL, NULL),
(66, 2, 'deposit', 10.00000000, NULL, 'completed', NULL, 'Bid DOWN on bitcoin (Fee: $0.3000)', '2026-03-15 13:09:55', 'BEP20', NULL, NULL),
(67, 2, 'deposit', 0.30000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 13:09:55', 'BEP20', NULL, NULL),
...
(69, 4, 'deposit', 100.00000000, NULL, 'completed', NULL, 'Bid UP on bitcoin (Fee: $3.0000)', '2026-03-15 13:27:17', 'BEP20', NULL, NULL),
(70, 4, 'deposit', 3.00000000, NULL, 'completed', NULL, '3% trading fee on bitcoin', '2026-03-15 13:27:17', 'BEP20', NULL, NULL),
(71, 4, 'deposit', 197.00000000, NULL, 'completed', NULL, 'Won bid on bitcoin (Round #23)', '2026-03-15 13:27:51', 'BEP20', NULL, NULL),
...
ALTER TABLE `bid_rounds`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_coin_slot` (`coin_id`,`slot_number`,`duration`),
...
--
-- Indexes for table `fd_upi_accounts`
--
ALTER TABLE `fd_upi_accounts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fd_usdt_wallets`
--
ALTER TABLE `fd_usdt_wallets`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `fd_upi_accounts`
--
ALTER TABLE `fd_upi_accounts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fd_usdt_wallets`
--
ALTER TABLE `fd_usdt_wallets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
